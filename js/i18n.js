...
(function (global) {
  ...
  var STR = {
    en: {
      ...
      'sett.promoLead':
        'Images under Discover categories (non-professional users). One HTTPS image URL per line. Auto-rotates in the app about every 2 seconds. Hidden when empty.',
      'sett.promoLbl': 'Image URLs (one per line)',
      'sett.promoPh': 'https://…/banner1.png',
      'sett.promoHint': 'Max 12 URLs. Only http(s) links. Use Firebase Storage or any CDN.',
    ...
    ar: {
      ...
      'sett.promoLead':
        'صور تحت فئات الاستكشاف (للمستخدمين غير المحترفين). رابط صورة HTTPS في كل سطر. يتبدّل تلقائياً في التطبيق كل نحو ثانيتين. يُخفى عند الفراغ.',
      'sett.promoLbl': 'روابط الصور (سطر لكل رابط)',
      'sett.promoPh': 'https://…/banner1.png',
      'sett.promoHint': '١٢ رابطاً كحد أقصى. روابط http أو https فقط. استضف الملفات على Firebase Storage أو أي CDN.',
