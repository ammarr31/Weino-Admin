...
(function (global) {
  ...
  var STR = {
    en: {
      ...
      'sett.promoForeverLbl': 'Show forever',
      'sett.promoAdPriceLbl': 'Ad amount paid (optional)',
      'sett.promoSortHint': 'Higher amount → appears first in the carousel (app). Leave empty for organic order among unpaid slides.',
      'sett.promoImportLines': 'Import lines as slides',
    ...
    ar: {
      ...
      'sett.promoForeverLbl': 'تظهر للأبد',
      'sett.promoAdPriceLbl': 'مبلغ الإعلان المدفوع (اختياري)',
      'sett.promoSortHint': 'مبلغ أعلى → يظهر أولاً في السلايدر. اتركه فارغاً لترتيب عادي بين الشرائح غير المدفوعة.',
      'sett.promoImportLines': 'استيراد الأسطر كشرائح',
